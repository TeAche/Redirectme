...
<div id="services" class="section section-expand">
    ...
    <div class="container">
                ...
                <ul class="thumbnails">
                    <li class="span3">
                        <div class="thumbnail">
                            ...
                            <a href="{{ URL::route("product/product/add") }}" class="btn goto-folio">Создать</a>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <ul class="thumbnails">
            ...
            <li class="span3">
                <a href="{{ URL::route("product/product/edit") }}?id={{ $product->id }}">
                <div class="thumbnail">
                    <img data-src="holder.js/300x200" alt="">
                    <h4>{{ $product->id . ". " . $product->title }}</h4>
                </div>
                </a>
                <div class="custom-icon"><a href="{{ URL::route("product/product/delete") }}?id={{ $product->id }}"><h4>X</h4></a></div>
            </li>
            @endforeach
        </ul>
        <div class="row">
